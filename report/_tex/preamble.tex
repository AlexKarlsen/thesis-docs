...
%
\documentclass[a4paper, listof=nochaptergap, listof=numbered, headsepline]{scrreprt}
\usepackage{lmodern}
\usepackage{setspace}
...
% Custom counters:
\newcounter{enumdesci}
\newcounter{enumdescii}
\newcounter{enumdesciii}
\newcounter{enumdesciv}
% Redefinition:
\renewcommand*{\theenumdesci}{\arabic{enumdesci})}
\renewcommand*{\theenumdescii}{\Alph{enumdescii})}
\renewcommand*{\theenumdesciii}{\Roman{enumdesciii}}
\renewcommand*{\theenumdesciv}{\alph{enumdesciv}}
%
\newlist{enumdescript}{description}{4}
\setlist[enumdescript,1]{
	before={\stepcounter{enumdesci}\setcounter{enumdesci}{0}},%
	font={\phantomsection\normalfont\normalsize\bfseries\refstepcounter{enumdesci}\theenumdesci~}}
\setlist[enumdescript,2]{
	before={\stepcounter{enumdescii}\setcounter{enumdescii}{0}},%
	font={\phantomsection\normalfont\normalsize\bfseries\refstepcounter{enumdescii}\theenumdescii~}}
\setlist[enumdescript,3]{
	before={\stepcounter{enumdesciii}\setcounter{enumdesciii}{0}},%
	font={\phantomsection\normalfont\normalsize\bfseries\refstepcounter{enumdesciii}\theenumdesciii~}}
\setlist[enumdescript,4]{
	before={\stepcounter{enumdesciv}\setcounter{enumdesciv}{0}},%
...
%
\usepackage{titling}
\title{Edge Intelligence using Adaptive Early Exit Deep Neural Networks}
...
\renewcommand*{\tableofcontents}{\listoftoc[{\contentsname}]{toc}}% ToC under control 
...
%% Seaborn colorpalette
 ...
 \definecolor{sns-purple}{HTML}{8172b3}
 \definecolor{sns-brown}{HTML}{937860}
 \definecolor{sns-pink}{HTML}{da8bc3}
 \definecolor{sns-grey}{HTML}{8c8c8c}
 \definecolor{sns-yellow}{HTML}{ccb974}
