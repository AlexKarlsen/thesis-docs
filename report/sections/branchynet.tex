...
\begin{longtabu}{>{\bfseries}X|X[c]|X[2c]}
	...
	Layer &  \multicolumn2{c}{Avg. Pool, 1000-d fc, Softmax} \tabularnewline
	\bottomrule
\end{longtabu}
\vspace{-20pt} \textit{Source: \citetitle{huang_densely_2016}, by \citeauthor{huang_densely_2016} \cite{huang_densely_2016}, describes a full list of Densely Connected Networks (\gls{densenet}-121, \gls{densenet}-169, \gls{densenet}-201 and \gls{densenet}-264)}
