...
\begin{figure}
	\centering
	\subfloat[B-ResNet]{\includegraphics[width=.7\linewidth]{figures/edge/b-resnet_correctness}}
	\hfill
	\subfloat[B-DenseNet]{\includegraphics[width=.7\linewidth]{figures/edge/b-densenet_correctness}}
