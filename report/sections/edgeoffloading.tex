...
\begin{figure}
	...
	\subfloat[B-ResNet]{\includegraphics[height=.27\textheight, keepaspectratio]{figures/edge/b-resnet_theoretical_score_combinations}}
	\hfill
	\subfloat[B-DenseNet]{\includegraphics[height=.27\textheight, keepaspectratio]{figures/edge/b-densenet_theoretical_score_combinations}}
	\hfill
	\subfloat[MSDNet]{\includegraphics[height=.27\textheight, keepaspectratio]{figures/edge/msdnet_theoretical_score_combinations}}
...
\begin{figure}
	...
	\subfloat[]{\includegraphics[width=\linewidth]{figures/edge/jetson_offloading}}
	\hfill
...
\begin{figure}
	...
	\hfill
	\subfloat[B-ResNet]{\includegraphics[width=\textwidth,height=.29\textheight,keepaspectratio]{figures/edge/b-resnet_offloading_vs_local}}
	\hfill
	\subfloat[B-DenseNet]{\includegraphics[width=\textwidth,height=.29\textheight,keepaspectratio]{figures/edge/b-densenet_offloading_vs_local}}
	\hfill
	\subfloat[MSDNet]{\includegraphics[width=\textwidth,height=.29\textheight,keepaspectratio]{figures/edge/msdnet_offloading_vs_local}}
