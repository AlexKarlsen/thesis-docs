...
\begin{figure}
	...
	\caption[Offloading scheme]{\gls{aee} edge offloading: \protect\subref{fig:offloading-scheme-successful} continuous prediction received with no timeouts. \protect\subref{fig:offloading-sceme-timeout} 2 predictions received prior to timeout. }
