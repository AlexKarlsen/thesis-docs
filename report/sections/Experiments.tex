...
Training B-\gls{resnet} and B-\gls{densenet} shows the importance of the densely connected layers for an early exiting model. The early exits of B-\gls{densenet} have a higher accuracy compared to B-\gls{resnet}, however B-\gls{resnet} have a higher end-accuracy, see figure \ref{fig:b-net-miniimagenet-100}. 
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figures/threshold_plots/timing_densenet100}
	\caption[Inference Analysis B-DenseNet]{Inference Analysis B-DenseNet}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figures/threshold_plots/threshold_analysis_densenet}
