...
In contrast to the \gls{branchynet} framework, that can be applied to existing \gls{dnn} architectures, \gls{msdnet} \cite{huang_multi-scale_2017} is a \gls{dnn} specifically designed for early exiting. \gls{msdnet} takes advantage of densely connected layers and add multi-scale paths to further improve early exiting capabilities, see figure \ref{fig:msdnet}.
